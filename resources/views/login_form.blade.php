    ...
    <div class="tw-pt-5 md:tw-pt-20 tw-px-5 md:tw-w-1/2 tw-w-full">
        <div class="tw-bg-teal-100 tw-border-t-4 tw-border-teal-500 tw-rounded-b tw-text-teal-900 tw-px-4 tw-py-1 md:tw-py-3 tw-shadow-md" role="alert">
            <div class="tw-flex">
                ...
                <div>
                    <p class="tw-font-bold tw-font-sans">Hello Friend</p>
                    <p class="tw-text-sm tw-font-sans">Welcome From A place to share knowledge and better understand the Electronics, Rebotics and Other Tech Platforms.</p>
                    ...
                    <div class="tw-block md:tw-hidden">
                        <div class="tw-flex tw-flex-col">
                            <login-form></login-form>
                            <hr class="tw-my-3">
                            <register-form class="tw-text-center tw-mb-3"></register-form>
                        </div>
                    </div>
                </div>
            </div>
